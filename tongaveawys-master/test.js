...
//var privateKey = new toncore.PrivateKey();
var wif = require('./config.js').wif;

var privateKey = new toncore.PrivateKey(wif);
...
/*
http://104.236.12.147:3001/insight-api-ton/addr/ton
{"addrStr":"ton","balance":0.0001,"balanceSat":10000,"totalReceived":0.0001,"totalReceivedSat":10000,"totalSent":0,"totalSentSat":0,"unconfirmedBalance":0,"unconfirmedBalanceSat":0,"unconfirmedTxApperances":0,"txApperances":1,"transactions":["45aa039b07135f4c0273367f7031ab4c0c78ad290309dec4e91f0f3e8b7fed85"]}
/*
var wif = 'Kxr9tQED9H44gCmp6HAdmemAzU3n84H3dGkuWTKvE23JgHMW8gct';
var address = new toncore.PrivateKey(wif).toAddress();
*/

var baseUrl = 'http://104.236.12.147:3001';
requestAsync({ url: baseUrl + '/insight-api-ton/addr/:addr/utxo'.replace(':addr', addr), json: true }).then(function (resp) {
  ...
  // NOTE: In ton the fee is 0.001 per input according to
  // https://github.com/tonevo/insight-api-ton#instantsend-transactions
  ...
  var restTx = {
    url: baseUrl + '/insight-api-ton/tx/send'
  , method: 'POST'
  , json: {
      rawtx: rawTx
    }
